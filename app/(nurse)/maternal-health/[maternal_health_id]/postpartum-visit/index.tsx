...
export default function NursePostpartumVisitsScreen() {
  ...
  const [hasPregnancyOutcome, setHasPregnancyOutcome] = useState(false);
        ...
        <View style={styles.bannerCard}>
          ...
          <View>
            ...
            {recordStatus && (
              <View style={[
                styles.statusBadge,
                recordStatus.toLowerCase() === 'completed' && styles.statusBadgeCompleted
              ]}>
        ...
        {visits.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <ThemedText style={styles.emptySubtext}>
              Postpartum visit records will appear here once added by authorized personnel.
            </ThemedText>
          </View>
        ) : (
          <>
...
const styles = StyleSheet.create({
  ...
  statusBadgeCompleted: { backgroundColor: theme.colors.successLight },
  statusText: { fontSize: 11, fontWeight: '700', color: theme.colors.success },
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', color: theme.colors.textPrimary, marginTop: theme.spacing.lg },
  emptySubtext: {
    fontSize: 14,
  ...
  visitBadgeText: { fontSize: 12, fontWeight: '700', color: theme.colors.primary },
  visitDate: { fontSize: 13, fontWeight: '600', color: theme.colors.textSecondary },
  ...
  notesSectionHeader: { flexDirection: 'row', alignItems: 'center', gap: theme.spacing.xs, marginBottom: theme.spacing.xs },
  notesLabel: { fontSize: 13, fontWeight: '700', color: theme.colors.success },
  notesText: { fontSize: 13, color: theme.colors.textPrimary, lineHeight: 18 },
  ...
  recordInfoText: { fontSize: 10, color: theme.colors.textMuted, fontStyle: 'italic' },
});
