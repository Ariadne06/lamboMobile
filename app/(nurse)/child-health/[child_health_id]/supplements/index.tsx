...
export default function NurseSupplementsListScreen() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.loadingContainer}>
          ...
          <ThemedText style={styles.loadingText}>Loading supplement records...</ThemedText>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerCard}>
        <View style={styles.headerContent}>
          <View style={styles.headerLeft}>
            <MaterialIcons name="medical-services" size={22} color={theme.colors.vitaminA} />
            <View>
              <ThemedText style={styles.childName}>{childName}</ThemedText>
              <ThemedText style={styles.recordCount}>
                {records.length} {records.length === 1 ? 'supplement' : 'supplements'} given
              </ThemedText>
            </View>
          </View>
        </View>
      ...
      <View style={styles.infoNotice}>
        ...
        <ThemedText style={styles.infoText}>
          You can view supplement records administered by the BHW.
        </ThemedText>
      </View>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={handleRefresh} colors={[theme.colors.vitaminA]} />
        }
      >
        {records.length === 0 ? (
          <View style={styles.emptyContainer}>
            <MaterialIcons name="medical-services" size={56} color={theme.colors.textMuted} />
            <ThemedText style={styles.emptyTitle}>No Supplement Records</ThemedText>
            <ThemedText style={styles.emptySubtext}>
              No supplements have been administered yet. BHW will record vitamin A and deworming doses.
            </ThemedText>
          </View>
        ) : (
          <View style={styles.listContainer}>
            {records.map((record, index) => {
              ...
              return (
                <View
                  key={`${record.supplement_id}-${record.date_given}-${index}`}
