    ...
    <ScrollView style={styles.container}>
      <View style={styles.infoBox}>
        ...
        <ThemedText style={styles.subtitle}>
          Review your medical conditions and surgical procedures.
        </ThemedText>
      </View>
      ...
      <View style={styles.noteBox}>
        ...
        <ThemedText style={styles.noteText}>
          Keeping an updated record of your medical and surgical history helps your healthcare provider give you the best care.
        </ThemedText>
      </View>
    </ScrollView>
  );
