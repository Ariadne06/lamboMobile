...
export default function MaternalHealthListScreen() {
  ...
  const handleAddRecord = () => {
    router.push('/(bhw)/maternal-health/create-maternal-record');
  };
  ...
  const handleCardPress = (maternalHealthId: number) => {
    router.push(`/(bhw)/maternal-health/${maternalHealthId}` as any);
  };
          ...
          <View style={styles.emptyContainer}>
            ...
            <ThemedText style={styles.emptySubtext}>
              {searchQuery
                ...
                : 'Tap the + button to add your first maternal health record'}
            </ThemedText>
          </View>
        ) : (
