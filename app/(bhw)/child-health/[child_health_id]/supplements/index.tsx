...
export default function SupplementsListScreen() {
  ...
  const handleAddSupplement = () => {
    router.push(`/(bhw)/child-health/${child_health_id}/supplements/add-supplement` as any);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerCard}>
        <View style={styles.headerContent}>
          ...
          <TouchableOpacity style={styles.addIconButton} onPress={handleAddSupplement}>
            <Ionicons name="add" size={24} color={theme.colors.vitaminA} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      >
        {records.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <TouchableOpacity style={styles.emptyButton} onPress={handleAddSupplement}>
      ...
      {/* FAB */}
      {records.length > 0 && (
        <TouchableOpacity style={styles.fab} onPress={handleAddSupplement} activeOpacity={0.85}>
